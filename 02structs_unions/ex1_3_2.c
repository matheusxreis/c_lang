...
void
format (struct realtype *real, int left, int right)
{
...
void
multiply (struct realtype *r1, struct realtype *r2, struct realtype *r3)
{
...
void
subtract (struct realtype *r1, struct realtype *r2, struct realtype *r3)
{
...
void
add (struct realtype *r1, struct realtype *r2, struct realtype *r3)
{
