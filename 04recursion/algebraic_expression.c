...
char
getsymb (char *str, int length, int *currentPos)
{
...
int
expr (char *str, int length, int *currentPos)
{
...
int
term (char *str, int length, int *currentPos)
{
...
int
factor (char *str, int length, int *currentPos)
{
  ...
  return (expr (str, length, currentPos)
	  && getsymb (str, length, currentPos) == ')');
}
