...
void reduce(RATIONAL* rat, RATIONAL* rat2) {
...
void sub(
  ...
  if(rat1->denominator == rat2->denominator) {
    ...
    r3.numerator = (rat1->numerator * rat2->denominator) - (rat2->numerator * rat1->denominator);
...
_Bool equal(RATIONAL* rat1, RATIONAL* rat2) {
  RATIONAL r1, r2;
  reduce(rat1, &r1);
  reduce(rat2, &r2);
