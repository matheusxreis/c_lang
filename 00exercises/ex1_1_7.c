...
main ()
{
  ...
  ternary_to_binary (ternary2, (sizeof (ternary2) / sizeof (ternary2[0])),
		     binary2);
...
int
ternary_to_binary (int ternary[], int size, int binary[])
{
...
int
binary_to_ternary (int binary[], int size, int ternary[])
{
...
int
read_ternary (int ternary[], int size)
{
