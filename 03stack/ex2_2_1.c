...
void
routine_a (struct Stack *s, void *i)
{
  pop (s);
  *(char *) i = *(char *) (pop (s));
};
...
void
routine_b (struct Stack *s1, struct Stack *s2, void *i)
{
  push (s2, pop (s1));
  *(char *) (i) = *(char *) pop (s1);
  push (s2, i);
...
void
routine_c (struct Stack *s1, void *i, int n)
{
...
void
routine_d (struct Stack *s1, struct Stack *s2, void *i, int n)
{
  for (int index = 0; index < n - 1; index++)
    {
      push (s2, pop (s1));
...
void
routine_e (struct Stack *s1, void *i)
{
...
void
routine_f (struct Stack *s1, struct Stack *s2, void *i)
{
  while (!empty (s1))
    {
      push (s2, pop (s1));
...
void
routine_g (struct Stack *s1, struct Stack *s2, void *i)
{
